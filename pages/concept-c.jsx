...
export default function ConceptC() {
  return (
    <div className="flex flex-col max-w-[430px] mx-auto min-h-screen bg-baby-sky subpixel-antialiased">
      <Head>
        <title>Sean이의 돐잔치 🎂</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Sean이의 돐잔치에 놀러오세요! 🎉" />
        <meta property="og:description" content="우리 Sean이가 벌써 첫 생일을 맞이했어요!" />
      </Head>

      {/* Hero Section - Rounded card feel */}
      <section className="px-4 pt-8 pb-4">
        <div className="relative bg-white rounded-3xl overflow-hidden shadow-lg">
          {/* Photo area */}
          <div className="w-full h-[380px] bg-baby-blue/30 flex items-center justify-center relative">
            <img src="/images/sean-main.png" alt="시온" className="w-52 h-52 rounded-full object-cover border-4 border-white shadow-lg" />
            {/* Decorative elements */}
            ...
            <div className="absolute bottom-8 right-6 text-xl">🍰</div>
          </div>
          {/* Name overlay */}
          <div className="text-center py-6 bg-white">
            <p className="font-cute text-xs text-baby-blue tracking-widest mb-1">HAPPY FIRST BIRTHDAY</p>
            <h1 className="font-cute text-4xl text-gray-700">Sean</h1>
            <p className="font-nanum text-xs text-gray-400 mt-2">류시온 · 2025.8.13</p>
          </div>
        </div>
      </section>
