  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="flex flex-col gap-4 w-full max-w-xs">
        ...
        <Link href="/concept-c-5">
          <a className="block p-6 bg-baby-sky rounded-xl border border-baby-blue hover:shadow-lg transition-shadow text-center">
            <div className="text-lg font-gowun text-gray-700 mb-1">Concept C-5</div>
            <div className="text-sm font-nanum text-gray-500">Full-width hero, leaf branches, sparkles, tagline</div>
          </a>
        </Link>
